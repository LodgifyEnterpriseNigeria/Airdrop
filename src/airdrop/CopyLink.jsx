...
export default function CopyLink({ title, message }) {
  ...
  return (
    <div className="w-10/12 py-4 md:py-8 px-0 mx-auto">
      <div className="w-full border-white border-[0.2px] rounded-2xl md:rounded-4xl bg-gradient-to-r from-[#29113e] to-[#1B0B29] px-4 md:px-8 py-8 md:py-16">
        {/* Link Container */}
        <div className='flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 bg-[#1B0B29] rounded-lg py-4 md:py-6 px-4 md:px-8 mb-6 w-full'>
