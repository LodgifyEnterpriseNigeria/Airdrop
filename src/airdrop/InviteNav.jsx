...
const NavBar = () => {
  ...
  const navItems = [
    ...
    { name: 'Earn', link: '#' },
    { name: 'Leaderboard', link: '/waitlist/leaderboard' },
  ]

  return (
    <motion.div 
      className='w-full fixed top-0 left-0 right-0 z-50 px-4 pt-4'
      initial={{ opacity: 0, y: -20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.5 }}
    >
      {/* Glassmorphism background */}
      <div className='absolute inset-0 bg-gradient-to-r from-purple-900/20 via-purple-800/20 to-purple-900/20 backdrop-blur-lg rounded-2xl' />
